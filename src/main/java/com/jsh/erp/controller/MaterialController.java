                ...
                for (MaterialVo4Unit material : dataList) {
                    ...
                    for (int i = 0; i < mpArr.length; i++) {
                        ...
                        if (mpArr[i].equals("材质")) {
                            MaterialName = MaterialName + ((material.getQuality() == null || material.getQuality().equals("")) ? "" : "(" + material.getQuality() + ")");
                        }
                        if (mpArr[i].equals("尺寸")) {
                            MaterialName = MaterialName + ((material.getSize() == null || material.getSize().equals("")) ? "" : "(" + material.getSize() + ")");
                        }
                    }
