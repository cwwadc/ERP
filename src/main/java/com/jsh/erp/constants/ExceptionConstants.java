...
public class ExceptionConstants {
     ...
     * */
    //添加支付方式信息失败
    public static final int PAYTYPE_ADD_FAILED_CODE = 4600000;
    public static final String PAYTYPE_ADD_FAILED_MSG = "添加支付方式失败";
    //删除支付方式信息失败
    public static final int PAYTYPE_DELETE_FAILED_CODE = 4600001;
    public static final String PAYTYPE_DELETE_FAILED_MSG = "删除支付方式失败";
    //修改支付方式信息失败
    public static final int PAYTYPE_EDIT_FAILED_CODE = 4600002;
    public static final String PAYTYPE_EDIT_FAILED_MSG = "修改支付方式失败";
     ...
     * */
    //添加客户组信息失败
    public static final int Customergroup_ADD_FAILED_CODE = 4600000;
    public static final String Customergroup_ADD_FAILED_MSG = "添加客户组失败";
    //删除客户组信息失败
    public static final int Customergroup_DELETE_FAILED_CODE = 4600001;
    public static final String Customergroup_DELETE_FAILED_MSG = "删除客户组失败";
    //修改客户组信息失败
    public static final int Customergroup_EDIT_FAILED_CODE = 4600002;
    public static final String Customergroup_EDIT_FAILED_MSG = "修改客户组失败";
