...
public class SupplierService {
    ...
    public List<Supplier> select(String province, String nature,String supplier, String type, String phonenum,
                                 String telephone, String description, int offset, int rows) throws Exception{
        List<Supplier> resList = new ArrayList<Supplier>();
        try{
            List<Supplier> list = supplierMapperEx.selectByConditionSupplier(province, nature,supplier, type, phonenum, telephone, description, offset, rows);
            for(Supplier s : list) {
    ...
    public Long countSupplier(String province, String nature, String supplier, String type, String phonenum, String telephone, String description) throws Exception{
        Long result=null;
        try{
            result=supplierMapperEx.countsBySupplier(province, nature, supplier, type, phonenum, telephone, description);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
        return result;
    ...
    public List<Supplier> findByAll(String province, String nature, String supplier, String type, String phonenum,
                                    String telephone, String description) throws Exception{
        List<Supplier> list=null;
        try{
            list = supplierMapperEx.findByAll(province, nature, supplier, type, phonenum, telephone, description);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
        return list;
