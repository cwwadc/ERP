...
public class DepotItemVo4WithInfoEx extends DepotItem{
    ...
    private Boolean royaltyMethod;          //提成方式 0固定提成 1百分比提成

    private BigDecimal wholesaleRoyalty;    //批发提成

    private BigDecimal retailRoyalty;       //零售提成
    ...
    public Boolean getRoyaltyMethod() {
        return royaltyMethod;
    }

    public void setRoyaltyMethod(Boolean royaltyMethod) {
        this.royaltyMethod = royaltyMethod;
    }
