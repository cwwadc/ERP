...
public class RMBChangeUtils {
    ...
    public static String rmbChange(String rmb) {
        String a = capitalization(String.valueOf(getNumByte(rmb, -1)));
        String b = capitalization(String.valueOf(getNumByte(rmb, -2)));
        if ("零".equals(a) && "零".equals(b)){
    ...
    public static void main(String[] args) {
        System.out.println(rmbChange("0.00"));
